        ...
        <div class="tab-content">
            <div id="regisTeach" class="container tab-pane active">
                <form method="POST" action="add_register.php">
                    ...
                    <div class="form-group">
                        <label for="password">รหัสผ่าน *</label>&nbsp;<span class="badge badge-info"
                            style="font-weight:normal;">(กรอกอักษร a-z,A-z และตัวเลข 0-9 จำนวน 6-10 ตัวเท่านั้น)</span>
                        <input type="password" class="form-control" id="password" name="password" pattern="[A-Za-z0-9]{6,10}"
                    ...
                    <div class="form-group">
                        <label for="phone">เบอร์โทรศัพท์ *</label>&nbsp;<span class="badge badge-info"
                            style="font-weight:normal;">(ไม่ต้องใส่ขีด)</span>
                        <input type="text" class="form-control" id="phone" name="phone" placeholder="Phone"
                            autocomplete="off" required OnKeyPress="return chkNumber(this)">
                        <!-- <small id="emailHelp" class="form-text text-muted">Password incorrect.</small> -->
                    </div>
                ...
                <form method="POST" action="add_register.php">
                    ...
                    <div class="form-group">
                        <label for="user_id">รหัสนักศึกษา *</label>&nbsp;<span class="badge badge-info"
                            style="font-weight:normal;">(ตัวอย่าง: 60302xxxx-x *ใส่ขีดด้วย*)</span>
                        <input type="text" class="form-control" id="user_id" name="user_id" placeholder="60302xxxx-x"
                            autocomplete="off" required OnInput="add_hyphen()" maxlength="11" OnKeyPress="return chkNumber(this)" pattern="[0-9]{8,8}.[-].[0-9]{0,0}">
                        <!-- <small id="emailHelp" class="form-text text-muted">Password incorrect.</small> -->
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" class="form-control" id="col_year" name="col_year" placeholder="ชั้นปีที่" required
                                autocomplete="off" maxlength="1" OnKeyPress="return chkNumber1(this)">
                        </div>
                    </div>
                    <br>
                    <a href="../login.php" class="btn btn-warning" role="button" aria-pressed="true"><img src="https://image.flaticon.com/icons/svg/709/709606.svg" width="15px">&nbsp;ไปเข้าสู่ระบบ</a>
