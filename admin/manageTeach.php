                    ...
                    <div class="edit-Teach-result">
                        <div style="padding:30px;">
                            ...
                            <div class="form-group">
                                <label for="Teachemail">อีเมล *</label>&nbsp;<span class="label label-info"
                                    style="font-weight:normal;">(ใช้ @kku.ac.th เท่านั้น)</span>
                                <input type="email" class="form-control" id="Teachemail" name="Teachemail"
                                    placeholder="user@kku.ac.th" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label for="Teachpassword">รหัสผ่าน *</label>&nbsp;<span class="label label-info"
                                    style="font-weight:normal;">(กรอกอักษร a-z,A-z และตัวเลข 0-9 จำนวน 6-10
                                    ตัวเท่านั้น)</span>
                                <input type="text" class="form-control" id="Teachpassword" name="Teachpassword"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="Teachfullname" name="Teachfullname"
                                    placeholder="Full Name" autocomplete="off" required>
                            </div>
                            <div class="form-group">
                                <label for="Teachphone">เบอร์โทรศัพท์ *</label>&nbsp;<span class="label label-info"
                                    style="font-weight:normal;">(ไม่ต้องใส่ขีด)</span>
                                <input type="text" class="form-control" id="Teachphone" name="Teachphone"
