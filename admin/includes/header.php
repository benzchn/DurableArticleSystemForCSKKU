            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown" id="navSetting">
                        ...
                        <ul class="dropdown-menu">
                            <li id="topNavSetting"><a href="setting.php"><img
                                        src='https://image.flaticon.com/icons/svg/1293/1293874.svg' width="21px"
                                        height="21px"> ตั้งค่า</a></li>
                            <li id="topNavLogout"><a href="logout.php"><img
                                        src='https://image.flaticon.com/icons/svg/1716/1716282.svg' width="21px"
                                        height="21px"> ออกจากระบบ</a></li>
                        </ul>
                    </li>
                    <li>
                        <?php 
