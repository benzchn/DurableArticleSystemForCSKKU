        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="editStdForm" action="php_action/editStduser.php" method="POST">
                    ...
                    <div class="edit-Std-result">
                        <div style="padding:30px;">
                            ...
                            <div class="form-group">
                                <label for="user_id">รหัสนักศึกษา *</label>&nbsp;<span class="label label-info"
                                ...
                                <input type="text" class="form-control" id="user_id" name="user_id"
                                    ...
                                    maxlength="11" OnKeyPress="return chkNumber(this)"
                                    pattern="[0-9]{8,8}.[-].[0-9]{0,0}">
                            </div>
                            <div class="form-group">
                                <label for="Stdpassword">รหัสผ่าน *</label>&nbsp;<span class="label label-info"
                                    style="font-weight:normal;">(กรอกอักษร a-z,A-z และตัวเลข 0-9 จำนวน 6-10
                                    ตัวเท่านั้น)</span>
                                <input type="text" class="form-control" id="Stdpassword" name="Stdpassword"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="Stdfullname" name="Stdfullname"
                                    placeholder="Full Name" autocomplete="off" required>
                            </div>
                            <div class="form-group">
                                <label for="Stdemail">อีเมล *</label>&nbsp;<span class="label label-info"
                            ...
                            <div class="form-group">
                                <label for="Stdphone">เบอร์โทรศัพท์ *</label>&nbsp;<span class="label label-info"
                                    style="font-weight:normal;">(ไม่ต้องใส่ขีด)</span>
                                <input type="text" class="form-control" id="Stdphone" name="Stdphone"
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" class="form-control" id="col_year" name="col_year"
                                        placeholder="ชั้นปีที่" required autocomplete="off" maxlength="1"
                                        OnKeyPress="return chkNumber1(this)">
                                </div>
                            </div>
                ...
                <div class="modal-footer editStdFooter">
                    ...
                    <button type="submit" class="btn btn-success" id="editStdBtn" name="editStdBtn"
