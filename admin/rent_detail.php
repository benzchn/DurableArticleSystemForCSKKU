                ...
                <div class="modal-body">
                    ...
                    <div class="edit-categories-result">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="editProductCode"
                                    placeholder="รหัสครุภัณฑ์" name="editProductCode" autocomplete="off" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-sm-1 control-label">: </label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="editUser" placeholder="ชื่อผู้ยืม"
                                    name="editUser" autocomplete="off" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-sm-1 control-label">: </label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="RentEtc" placeholder="รายละเอียดเพิ่มเติม.."
                                    name="RentEtc" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <label class="col-sm-1 control-label">: </label>
                            <div class="col-sm-7">
                                <input type="date" class="form-control" id="RentDate" placeholder="วันที่ยืม"
                                    name="RentDate" autocomplete="off" >
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <label class="col-sm-1 control-label">: </label>
                            <div class="col-sm-7">
                                <input type="date" class="form-control" id="ReturnDateFix" placeholder="วันที่กำหนดคืน"
                                    name="ReturnDateFix" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <label class="col-sm-1 control-label">: </label>
                            <div class="col-sm-7">
                                <input type="date" class="form-control" id="ReturnDate" placeholder="วันที่ผู้ยืมคืน"
                                    name="ReturnDate" autocomplete="off">
                            </div>
                        </div>
